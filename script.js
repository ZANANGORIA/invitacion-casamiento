...
function initCalendarBtn() {
    ...
    btn.addEventListener('click', () => {
        const icsLines = [
            ...
            'BEGIN:VALARM',
            'TRIGGER;VALUE=DATE-TIME:20260901T110000',
            'ACTION:DISPLAY',
            'DESCRIPTION:Recordatorio Casamiento',
            'END:VALARM',
            'END:VEVENT',
            'BEGIN:VEVENT',
            ...
            'X-APPLE-DEFAULT-ALARM:FALSE',
            'BEGIN:VALARM',
            'TRIGGER;VALUE=DATE-TIME:20261010T110000',
            'ACTION:DISPLAY',
            'DESCRIPTION:Casamiento de Mayra y Gabriel',
            'END:VALARM',
            'END:VEVENT',
            'END:VCALENDAR'
        ];
